...
from resorter import parse_input, determine_queries, generate_bin_edges, BradleyTerryModel, main
...
class TestCodeUnderTest:
    ...
    def test_standard_error_after_random_choice(mocker):
        ...
        expected_se = ((alpha * beta) / ((alpha + beta) ** 2 * (alpha + beta + 1))) ** 0.5
    ...
    def test_cli_integration(self):
        ...
        # Simulate the user input for the choices (e.g., "1\n2\n3\n" for choosing options 1, 2, and 3 in sequence)
        user_input = "1\n1\n1\n1\n1"
